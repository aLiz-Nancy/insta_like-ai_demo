...
export const TagsInputItemPreview: typeof ChakraTagsInput.ItemPreview =
  ChakraTagsInput.ItemPreview;
export const TagsInputItemInput = ChakraTagsInput.ItemInput;
export const TagsInputItemContext: typeof ChakraTagsInput.ItemContext =
  ChakraTagsInput.ItemContext;
...
export const TagsInputContext: typeof ChakraTagsInput.Context =
  ChakraTagsInput.Context;
export const TagsInputHiddenInput: typeof ChakraTagsInput.HiddenInput =
